...
cfg = {
    ...
    "paths": {
        "name": "new_losses_rst2",  # name the run/output dir
        "output_dir": "Pipelines/RST/outputs",  # Base output directory
    ...
    "model": {
        ...
        "grid_range": [-1.2, 1.2]        # Range for KAN grid
    },
    ...
    "training": {
        ...
        "lambda": 0.0005,         # Weight decay (can be "" if unused)
        "alpha": 0.99,            # Alpha for RMSprop (ignored for Adam)
    
        "epochs": 3000,            # Total number of epochs
        ...
        "loss":{
            ...
            "terms": {
                "phys": {
                    "enabled": True,
                    "types": ['tke'],  # or your actual phys loss type
                        },
                "constraint": {
                    "enabled": False,
                ...
                "data": {
                    ...
                    "types": ['frob'],  # Options: ["crit", "frob", "log_euclidean", "riemann", "spd"]
